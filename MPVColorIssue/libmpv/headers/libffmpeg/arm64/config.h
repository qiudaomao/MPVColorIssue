...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --enable-videotoolbox --disable-encoders --enable-encoder=png --enable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-hwaccels --enable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --enable-protocol=bluray --enable-protocol=concat --enable-protocol=crypto --enable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --enable-protocol=libssh --enable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --enable-filters --enable-iconv --enable-audiotoolbox --enable-videotoolbox --disable-linux-perf --disable-bzlib --enable-fontconfig --enable-libfreetype --enable-libfribidi --enable-libass --enable-libbluray --enable-libssh --enable-libnfs --enable-libdsm --enable-libsmb2 --enable-libaom --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/ffmpeg-arm64/output --enable-openssl --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -mios-version-min=11.0 -fembed-bitcode -I/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/openssl-arm64/output/include -I/Users/zfu/proj/github/tvos.mpv.player/contrib/ios-ffmpeg/prebuilt/ios-arm64-ios-darwin/libssh/include' --extra-cxxflags=' -arch arm64 -mios-version-min=11.0 -fembed-bitcode -I/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/openssl-arm64/output/include -I/Users/zfu/proj/github/tvos.mpv.player/contrib/ios-ffmpeg/prebuilt/ios-arm64-ios-darwin/libssh/include' --extra-ldflags=' -arch arm64 -mios-version-min=11.0 -fembed-bitcode -arch arm64 -mios-version-min=11.0 -fembed-bitcode -I/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/openssl-arm64/output/include -L/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/openssl-arm64/output/lib -lssl -lcrypto -L/Users/zfu/proj/github/tvos.mpv.player/contrib/ios-ffmpeg/prebuilt/ios-arm64-ios-darwin/libssh/lib -lssh'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/zfu/proj/website/LazyCat/BytePlayer/DanMuPlayer/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
...
#define CONFIG_LIBNFS_PROTOCOL 1
#define CONFIG_LIBDSM_PROTOCOL 1
